...
path = '/nlp/data/romap/law/task_5/models_1/shell/'
results_path = '/nlp/data/romap/law/task_5/models_1/title_results/'
bigram_results_path = '/nlp/data/romap/law/task_5/models_1/title_bigrams/'

tm_path = '/nlp/data/romap/law/task_5/models_1/title_models/'
...
def get_bigram_wvec():
    ...
    if concept is True:
        ...
        for line in lines:
            ...
            if word in bigrams:
                word_vecs[word] = vec
                fin_bigrams.append(word)
    f = open('/nlp/data/romap/law/fin_bigrams_test.txt', 'w+')
    for bigram in fin_bigrams: f.write(bigram+'\n')
    return word_vecs
...
#change word_vecs, test_words, X_test, y_test
